...
import (
	...
	"scheduler-operator/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "6157578d.uclm.es",
	...
	logMetricScheduler := ctrl.Log.WithName("controllers").WithName("MetricScheduler")

	if err = (&controllers.MetricSchedulerReconciler{
		Client:   mgr.GetClient(),
		Scheme:   mgr.GetScheme(),
		Log:      logMetricScheduler,
		Recorder: mgr.GetEventRecorderFor("metricscheduler-controller"),
